...
namespace Dapplo.Jira
{
    ...
    public class JiraClient : IProjectDomain, IWorkDomain, IUserDomain, ISessionDomain, IIssueDomain, IFilterDomain, IAttachmentDomain, IServerDomain, IAgileDomain, IGreenhopperDomain
    {
        ...
        /// </summary>
        public static IJiraClient Create(Uri baseUri = null, IHttpSettings httpSettings = null)
        {
        ...
        private JiraClient(Uri baseUri = null, IHttpSettings httpSettings = null)
        {
...
/// <param name="httpSettings">IHttpSettings or null for default</param>
        ...
        private IHttpBehaviour ConfigureBehaviour(IChangeableHttpBehaviour behaviour, IHttpSettings httpSettings = null)
        {
            ...
            behaviour.OnHttpRequestMessageCreated = httpMessage =>
            {
                ...
                if (!string.IsNullOrEmpty(_user) && !string.IsNullOrEmpty(_authToken))
                {
                    var encoded = Convert.ToBase64String(System.Text.Encoding.GetEncoding("ISO-8859-1").GetBytes($"{_user}:{_authToken}"));
                    httpMessage?.Headers.TryAddWithoutValidation("Authorization", "Basic " + encoded);
                }
                return httpMessage;
            };
            return behaviour;
        ...
        /// </summary>
        public Uri JiraBaseUri { get; private set; }

        /// <summary>
        ///     The rest URI for your JIRA server
        /// </summary>
        public Uri JiraRestUri { get; private set; }


        /// <summary>
        ///     The agile rest URI for your JIRA server
        /// </summary>
        public Uri JiraAgileRestUri { get; private set; }

        /// <summary>
        ///     The greenhopper rest URI for your JIRA server
        /// </summary>
        public Uri JiraGreenhopperRestUri { get; private set; }

        /// <summary>
        ///     The base URI for JIRA auth api
        /// </summary>
        public Uri JiraAuthUri { get; set; }

        /// <summary>
        ///     Set Base URL for the current client
        /// </summary>
        /// <param name="baseUri">Base URL, e.g. https://yourjiraserver</param>
        ...
        /// <summary>
        ///     Set Token Basic Authentication for the current client
        /// </summary>
        /// <param name="user">username</param>
        /// <param name="authToken">Auth Token</param>
        public void SetTokenBasicAuthentication(string user, string authToken)
        {
            _user = user;
